...
module has to offer a set of methodes which will be used from withing
gedafe. To first list the pearl in the Entry screen, then produce a custom
...
makes the creation of multilevel report simple. Check the separate documentation.

=head1 USAGE

To be written. Should include documentation on required methodes and services provided by the parent module.
